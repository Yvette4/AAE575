...
%		The last step is to take the coordinates calculated above and compute the pixel coordinates using Equations () - ().  
	% YVETTE - come back to this step last... what is it useful for...?
